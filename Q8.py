...
mu_1_var=prior_s1_mean
mu_2_mean=prior_s1_mean
mu_2_var=prior_s1_mean

mu_3_mean=prior_s2_var
mu_3_var=prior_s2_var
mu_4_mean=prior_s2_var
...
# x = np.linspace(mean - 4 * np.sqrt(variance), mean + 4 * np.sqrt(variance), 1000)  # Adjust the range as needed
# y = norm.pdf(x, loc=mean, scale=variance)
